...
const PlaceOrder = () => {
    ...
    const initPay = (order) => {
        ...
        const rzp = new window.Raporpay(options);
        rzp.open()
    }
        ...
        <form onSubmit={onSubmitHandler}
            ...
            <div className={"flex flex-col gap-4 w-full sm:max-w-[480px]"}>
                <div className={"text-xl sm:text-2xl my-3"}>
                    <Title primaryText={"DELIVERY"} secondaryText={"INFORMATION"}/>
                </div>
                <div className={"flex gap-3"}>
                    <input required onChange={onChangeHandler} name="firstName" value={formData.firstName}
                           className={"border border-gray-300 rounded py-1.5 px-3.5 w-full"} type={"text"}
                ...
                <input required onChange={onChangeHandler} name="email" value={formData.email}
                       className={"border border-gray-300 rounded py-1.5 px-3.5 w-full"} type={"email"}
            ...
            <div className={"mt-8"}>
                ...
                <div className={"mt-12"}>
                    <Title primaryText={"PAYMENT"} secondaryText={"METHOD"}/>
